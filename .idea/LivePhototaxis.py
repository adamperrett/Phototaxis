...
def poisson_setting(label, connection):
    ...
    # calculat fitness
    current_fitness += calc_instant_fitness(current_agent, light_distance, light_theta)
    # calc new poisson rates
    sensor_poisson = poisson_rate(current_agent, light_distance, light_theta)
    ...
    for j in range(visual_discrete):
        ...
        connection.set_rates("input_spikes{}".format(j), sensor_poisson[j])
